  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          {/* ── Header ── */}
          <div className="flex-shrink-0 bg-gradient-to-r from-cyan-500 to-blue-600 text-white">
                  ...
                  {visibleCategories.map((cat) => {
                    ...
                    return (
                      <button
                        ...
                        className={`
                          flex-shrink-0 flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold
                  ...
                  <div className="space-y-4">
                    <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
                      <div className="flex items-start gap-3 mb-4">
                        <div
                          className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${activeCatConfig?.required ? "bg-cyan-50" : "bg-slate-100"}`}
                        >
                          {activeCatConfig && (
